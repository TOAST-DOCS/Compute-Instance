...
シリアルコンソール機能には、次のような制約事項があります。

* インスタンスごとに1つのシリアルコンソール接続のみ可能で、複数接続を試みた場合、正常に接続できないことがあります。
* 個人がアップロードしたイメージで作成したインスタンスと、個人イメージで作成したインスタンスは、シリアルコンソール接続を保証しません。
* シリアルコンソール接続は、最大10分間接続可能です。
* Windowsインスタンスはシリアルコンソール機能をサポートしていません。
* 2025年11月25日のデプロイ以前に作成したインスタンスは、**インスタンスの停止**後に**インスタンスの開始**が必要です。**インスタンスの再起動**機能では適用されません。
...
変更した設定を適用します。OSによってGRUB設定を適用するコマンドが異なる場合があります。
