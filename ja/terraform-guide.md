...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (t7 corresponds to k7 (Terraform provider 제공) which has no subheading for 'Local provider設定' in the ko outline) -->
<a id="local-provider"></a>
### Local provider設定 { #local-provider }
...
<!-- pre-align: ko에 대응 섹션 없음 — 검토 필요 (t9 corresponds to k8 (Terraform 초기화) which has no subheading for 'Local providerの交換' in the ko outline) -->
### Local providerの交換
