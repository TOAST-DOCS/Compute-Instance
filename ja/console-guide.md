...
> [参考] GPU Instance, Bare Metal Instanceは終了することができず、停止時にも通常(100%)料金が発生します。
...
インスタンスキーペアは、インスタンスがアクティブな場合のみ変更できます。インスタンス基本アカウントのキーペアを選択したキーペアに変更します。インスタンス基本アカウントは、インスタンス詳細画面の**接続情報**タブで確認できます。
