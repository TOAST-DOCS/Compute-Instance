...
Floating IP管理は、インスタンス > 管理ページまたはインスタンス > Floating IPページで行えます。Floating IPの詳細は、[VPCコンソール使用ガイド](/Network/VPC/ko/console-guide/)を参照してください。
...
ブロックストレージ管理は、インスタンス > ブロックストレージページでもできます。ブロックストレージの詳細は[ブロックストレージガイド](/Storage/Block%20Storage/ko/overview/)を参照してください。
