...
플로팅 IP에 대한 자세한 설명은 [VPC 개요](ko/Network/VPC/ko/overview/)를 참조합니다.

### 보안그룹 수정

인스턴스의 상태에 관계없이 인스턴스의 보안그룹을 수정할 수 있습니다. 수정된 보안그룹은 바로 적용됩니다.

보안 그룹에 대한 자세한 설명은 [보안 그룹](./console-guide/#_20)과 [VPC 개요](ko/Network/VPC/ko/overview/)를 참조합니다.
...
> [참고] 인스턴스의 기본 디스크 크기는 변경할 수 없습니다. 인스턴스의 디스크 공간이 부족하다면 블록 스토리지를 추가하여 사용합니다. 자세한 블록 스토리지 추가 방법은 [Block Storage 개요](/Storage/Block%20Storage/ko/overview/)를 참고합니다.
...
PuTTY ssh 클라이언트를 설치하면 함께 설치되는 puttygen 프로그램으로 키페어를 생성하고 TOAST에 등록하여 사용할 수 있습니다. PuTTY 설치는 [윈도우에서 PuTTY ssh 클라이언트로 리눅스 인스턴스에 접속하는 방법](./overview/#_10)을 참조합니다.
...
등록한 키페어는 인스턴스를 생성할 때 사용할 수 있고, 인스턴스 접속 시에는 이 키페어의 개인 키로 접속하여야 합니다. 인스턴스 접속 방법은 [Instance 개요](./overview/#_10)를 참조합니다.
...
등록한 키페어는 인스턴스를 생성할 때 사용할 수 있고, 인스턴스 접속 시에는 이 키페어의 개인 키로 접속하여야 합니다. 인스턴스 접속 방법은 [인스턴스 접속 방법](./overview/#_10)을 참조합니다.
