...
플로팅 IP 관리는 인스턴스 > 관리 페이지 또는 인스턴스 > 플로팅 IP 페이지에서도 할 수 있습니다. 플로팅 IP에 대한 보다 자세한 설명은 [플로팅 IP 개요](/Network/VPC/ko/overviw/)를 참고합니다.
...
보안 그룹에 대한 보다 자세한 설명은 [VPC 개요](/Network/VPC/ko/overview/)를 참고합니다.
...
기본 디스크는 OS 용도로만 사용하고 추가 디스크에 자주 사용하는 응용이나 데이터를 보관하면 블록 스토리지 연결/해제 또는 스냅샷 기능을 통해 쉽게 이전하거나 복제할 수 있습니다. 또한 인스턴스 장애시에 추가 디스크만 해제하여 다른 인스턴스에 연결하여 쉽게 서비스를 복구할 수 있습니다.

블록 스토리지 관리는 인스턴스 > 블록 스토리지 페이지에서도 할 수 있습니다. 블록 스토리지에 대한 보다 자세한 설명은 [블록 스토리지 개요](/Network/VPC/ko/overviw/)를 참고합니다.
...
* M, C, R, T, X 타입의 인스턴스는 M, C, R, T, X 타입의 인스턴스 사양으로 변경할 수 있습니다.
* M, C, R, T, X 타입의 인스턴스는 U 타입의 인스턴스 사양으로 변경할 수 없습니다.
