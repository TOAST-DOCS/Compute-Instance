...
**Compute > Instance** 서비스 페이지의 특정 인스턴스를 클릭하여 나오는 하단 상세 정보 화면의 **기본 정보** 탭에서 **OS > 변경**을 클릭하여 변경합니다.
...
**Compute > Instance** 서비스 페이지의 특정 인스턴스를 클릭하여 나오는 하단 상세 정보 화면의 **기본 정보** 탭에서 **키페어 > 변경**을 클릭하여 변경합니다.
