...
> [참고]
> MS-SQL Instance의 릴리스 현황은 [인스턴스 릴리스 노트](/Compute/Compute/ko/release-notes-ngcc/)를 참고하세요.
...
> MySQL Instance의 릴리스 현황은 [인스턴스 릴리스 노트](/Compute/Compute/ko/release-notes-ngcc/)를 참고하세요.
...
- 자세한 SSH 연결 가이드는 [SSH 연결 가이드](./overview-ngcc/#how-to-access-linux-instances)를 참고하세요.
