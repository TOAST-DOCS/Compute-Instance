...
> [참고]
> NHN Cloud가 제공하는 NKS 클러스터 애드온 상세 목록은 API 가이드의 [NHN Cloud에서 제공하는 애드온 목록 보기](/Container/NKS/ko/public-api/#nhn-cloud_3) 및 사용 가이드의 [애드온 목록](Container/NKS/ko/user-guide#addon-mgmt-addon-list) 항목을 참고해 주시기 바랍니다.
