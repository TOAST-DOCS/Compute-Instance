...
### Import Key Pairs (Windows) { #import-key-pairs-windows }
...
### Import Key Pairs (Mac and Linux) { #import-key-pairs-mac-and-linux }
...
## Appendix 4. Restarting Instances for Hypervisor Maintenance { #appendix-4-restarting-instances-for-hypervisor-maintenance }
