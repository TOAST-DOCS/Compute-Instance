...
| block_device.uuid | String | - | ID of original block storage to create |
| block_device.source_type | String | O | Type of original block storage to create<br>`image`: Create block storage with image <br>`blank`: Empty block device created with further volume created |
