...
| server.block_device_mapping_v2.volume_type | Body | Enum    | - | Type of block storage to be created<br>See `Name` from the response of **List Block Storage Types** in the `User Guide > Storage > Block Storage > API v2 guide`. |
